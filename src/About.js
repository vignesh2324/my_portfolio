    ...
    <div id="about-wrapper">
      <div className="about">
        <div className="about-text">
          <h3>About.</h3>
          <p>Hey, I'm Vignesh bakthavatchalam on a quest to conquer the realm of machine learning, unraveling algorithms, and chasing that data dream. Beyond the code, I'm all about Manchester United victories, the magic of Desi Indie beats, and mastering the TV show marathon game. In this journey, I'm all in, both in the tech arena and the world of entertainment!</p>
